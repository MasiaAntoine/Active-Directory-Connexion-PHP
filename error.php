            ...
            <div class="col-lg-7 mx-auto text-white">
              <div class="row align-items-center d-flex flex-row">
                <div class="col-lg-6 text-lg-right pr-lg-4">
                  <h1 class="display-1 mb-0">607</h1>
                </div>
                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                  <h2 class="text-uppercase">Erreur</h2>
                  <h3 class="font-weight-light">La connexion à l'Active Directory est refusée, votre fichier de connexion est mal configuré, veuillez vérifier votre configuration.</h3>
                </div>
              </div>
              <div class="row mt-5">
                <div class="col-12 text-center mt-xl-2">
                  <a class="text-white font-weight-medium" href="/">Clique pour une reconnexion</a>
                </div>
              </div>
            </div>
          </div>
